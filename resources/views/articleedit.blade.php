...
@section('main')
        <form method="post" action="{{route('adminpanel.article.input')}}"  enctype="multipart/form-data" class='gap-3'>
            @csrf
            @method('put')
            <input type="hidden" name='id' value="{{ old('id',$data['article'][0]['id']) }}" >
            <div class="form-group gap-3 form-row">
                <div class='col-10'>
                    <label for="name">نام محصول</label>
                    <input class="form-control" type="text" placeholder="نام محصول" name="name" id="name" value="{{ old('name',$data['article'][0]['name']) }}">
            ...
            <div class='form-row  gap-3'>
                ...
                <div class="form-group col-5">
                    ...
                    <input type="text" class="form-control" name='title' id="title" placeholder="عنوان"  value="{{ old('title',$data['article'][0]['title']) }}" >
            ...
            <div class="form-group gap-2">
                ...
                <textarea class="form-control" id="body" rows="3" name='body' placeholder="اطلاعاتی که می خواهید درباره محصول نمایش داده شود بنویسید"  > value="{{ old('body',$data['article'][0]['body']) }}"</textarea>
            </div>
