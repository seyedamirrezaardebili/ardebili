...
<form method="post" action="{{route('adminpanel.group.input')}}"  enctype="multipart/form-data" class='gap-3'>
            ...
            <div class="form-group gap-3 form-row">
                <div class='col-10'>
                    ...
                    <input class="form-control" type="text" placeholder="نام دسته بندی" name="name" id="name" >
            ...
            <div class='form-row  gap-3'>
                ...
                <div class="form-group col-5">
                    ...
                    <input type="text" class="form-control" name='title' id="ز" placeholder="عنوان" >
            ...
            <div class="form-group gap-2 col-10">
                ...
                <textarea class="form-control" id="body" rows="3" name='body' placeholder=" توضیحات  درمورد دسته بندی ها"  ></textarea>
            </div>
